      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
        ...
        {phase === "result" && result?.error && (
          <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
            <div>
              <p style={{ color: "#D4796B", fontSize: 17, marginBottom: 20 }}>Something went wrong. Please try again.</p>
              <button onClick={() => setPhase("loading")} style={{ background: "#E8935A", border: "none", borderRadius: 8, padding: "13px 30px", color: "#0D0D0D", cursor: "pointer", fontSize: 14 }}>Retry</button>
            </div>
          </div>
        )}
      </div>
