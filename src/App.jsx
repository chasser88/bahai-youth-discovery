...
Return ONLY a JSON object (no markdown, no backticks) with this exact structure:
{
  ...
  async function downloadPDF() {
    ...
    const MID    = [90, 84, 80];     // Mid grey
    const LIGHT  = [90, 84, 80];     // Body text (dark on white)
        ...
        {phase === "result" && result && !result.error && (
          <div style={{ padding: "60px 0" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              <p style={{ fontSize: 19, lineHeight: 1.8, color: "#5A5450", maxWidth: 540, margin: "0 auto" }}>{result.name_greeting}</p>
            </div>
