            ...
            <div style={{ textAlign: "center", padding: "44px 0", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                <button onClick={downloadPDF}
                  style={{ background: "#E8935A", border: "none", borderRadius: 8, padding: "14px 32px", color: "#0D0D0D", cursor: "pointer", fontSize: 15, fontWeight: 700, fontFamily: "'Georgia', serif", letterSpacing: 1 }}>
